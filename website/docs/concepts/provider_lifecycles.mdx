...
## What is this ProviderRef?

Every provider creation function is passed a [ProviderRef] object typically called `ref`. It is how providers interact with each other and their state lifecycles.
...
When an uninitialized provider is being [read] or [watch]ed it will be created.
...
:::warn
Do not create a ProviderContainer for use in flutter unless using UncontrolledProviderScope, and you are sure you know what you are doing.
:::
...
- When defined using the .autoDispose modifier and no longer being [watch]ed by the UI or another provider
...
A disposed provider is in the uninitialized state again, and will be created on demand when the provider is [watch]ed or [read] again.
...
[ref]: https://pub.dev/documentation/riverpod/latest/riverpod/ProviderRef-class.html
[watch]: https://pub.dev/documentation/riverpod/latest/riverpod/ProviderRef/watch.html
[read]: https://pub.dev/documentation/riverpod/latest/riverpod/ProviderRef/read.html
[ondispose]: https://pub.dev/documentation/riverpod/latest/riverpod/ProviderRef/onDispose.html
[statenotifierprovider]: https://pub.dev/documentation/riverpod/latest/riverpod/StateNotifierProvider-class.html
[providerreference]: https://pub.dev/documentation/riverpod/latest/riverpod/ProviderRef-class.html

...
a function or class, and is testable and maintainable.
:::
...
:::caution
While all providers have their purpose, [ChangeNotifierProvider]s are not recommended for scalable application, 
...
for some flutter specific use-cases such as integration with Navigator 2.
:::

To learn more about the difference between the provider types and how to use them most effectively see [Provider Types](/docs//concepts/provider_types)
